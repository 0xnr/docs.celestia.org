<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Celestia or dive straight into the code with guides.
    .features
      router-link(to="/specs/architecture").features__item.features__item__light
      ...
      router-link(to="/specs/networking").features__item.features__item__dark
        .features__item__image
          icon-code.features__item__image__img
        .features__item__text
          .features__item__text__h2 use
          .features__item__text__h1 Guides
          .features__item__text__p Follow guides to using polular tools with Celestia.
    .sections__wrapper
      .h2 Explore Celestia
      .p__alt Get familiar with Celestia and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Celestia stack.
    .stack
